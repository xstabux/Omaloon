/*package ol.world.blocks.production;
...
public class olBurstDrill extends Drill {
    ...
    public olBurstDrill(String name){
        super(name);
    ...
    public class olBurstDrillBuild extends DrillBuild{
