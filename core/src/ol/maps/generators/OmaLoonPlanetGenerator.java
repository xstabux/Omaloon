...
public class OmaLoonPlanetGenerator extends PlanetGenerator {
    ...
    public static Block[][] arr = new Block[][]{
            {Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.snow, Blocks.snow, Blocks.stone, Blocks.cryofluid, Blocks.stone, Blocks.snow, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.snow},
            {Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone},
            {Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.stone},
            {Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone},
            ...
            {Blocks.stone, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow},
            {Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.cryofluid, Blocks.cryofluid},
            {Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.cryofluid, Blocks.snow},
            ...
            {Blocks.snow, Blocks.cryofluid, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.snow, Blocks.cryofluid, Blocks.stone, Blocks.cryofluid, Blocks.cryofluid},
            ...
            {Blocks.stone, Blocks.stone, Blocks.snow, Blocks.cryofluid, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.snow},
            {Blocks.cryofluid, Blocks.stone, Blocks.cryofluid, Blocks.snow, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.stone, Blocks.stone, Blocks.cryofluid, Blocks.cryofluid, Blocks.cryofluid}
    };
