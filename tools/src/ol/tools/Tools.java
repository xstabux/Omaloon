...
public final class Tools{
    public static OmaloonMod omaloon;
    ...
    public static void main(String[] args){
        ...
        omaloon = new OmaloonMod();

        meta = new ModMeta(){{name = "ol";}};
        mod = new LoadedMod(null, null, omaloon, Tools.class.getClassLoader(), meta);

        Reflect.<Seq<LoadedMod>>get(Mods.class, mods, "mods").add(mod);
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(OmaloonMod.class, meta);
