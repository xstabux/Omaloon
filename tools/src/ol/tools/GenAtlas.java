...
public class GenAtlas extends TextureAtlas{
    ...
    /** The name should be prefixed with {@code ol-} */
    public GenRegion addRegion(Fi file){
        String name = file.nameWithoutExtension();
        if(!file.path().contains("sprites/vanilla/")) name = "ol-" + name;
    ...
    /** {@inheritDoc} The name should be prefixed with {@code ol-} */
    @Override
    ...
    public static class GenRegion extends AtlasRegion{
        ...
        public void save(boolean add){
            ...
            Fi file = dir.child(name.replaceFirst("ol-", "") + ".png");
